                    ...
                    case 0x80:
                        ...
                        while(j<=500)
                        {
                            if (_CP0_GET_COUNT()>=200000)
                            {
                                ...
                                x = (accels[0]*1.0*(2*sx-1))/160;
                                y = (accels[1]*1.0*(2*sy-1))/160;
                                z = (accels[2]*1.0*(2*sz-1))/160;
                            
                                appData.transmitDataBuffer[0] = sx;
                                appData.transmitDataBuffer[1] = x;
                                appData.transmitDataBuffer[2] = sy;
                                appData.transmitDataBuffer[3] = y;
